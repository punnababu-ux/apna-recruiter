...
declare function Button({ className, variant, size, loading, loadingText, disabled, children, ...props }: ButtonProps): react_jsx_runtime.JSX.Element;
...
declare const badgeVariants: (props?: ({
    variant?: "link" | "default" | "destructive" | "success" | "warning" | "info" | "outline" | "secondary" | "ghost" | null | undefined;
} & class_variance_authority_dist_types.ClassProp) | undefined) => string;
